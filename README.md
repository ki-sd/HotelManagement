...
본 프로젝트는 상용 서비스 운영 목적이 아닌, 백엔드 시스템의 전반적인 데이터 흐름을 이해하고 실무 아키텍처(MVC 패턴, DB 커넥션 풀, 프레임워크 동작 원리 등)를 직접 설계 및 검증해 보기 위한 **순수 학습 및 포트폴리오용 프로젝트**입니다.
...
![Oracle 21c](https://img.shields.io/badge/Oracle_21c-F00000?style=flat-square&logo=oracle&logoColor=white)
...
![Oracle Cloud (OCI)](https://img.shields.io/badge/Oracle_Cloud_(OCI)-C74634?style=flat-square&logo=oracle&logoColor=white)
